  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-5 rounded-2xl bg-[#131926] border border-[#232e42] shadow-md space-y-2">
          <div className="flex items-center justify-between text-slate-400 text-xs">
            <span>Questions Asked</span>
            <HelpCircle className="w-4 h-4 text-blue-400" />
          </div>
          <span className="text-3xl font-extrabold text-white block">{analytics.questions_asked}</span>
          <span className="text-[10px] text-slate-400 block">Total Q&A invocations</span>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-[#131926] border border-[#232e42] shadow-md space-y-2">
          ...
          <span className="text-[10px] text-slate-400 block">Ingested research files</span>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-[#131926] border border-[#232e42] shadow-md space-y-2">
          ...
          <span className="text-[10px] text-slate-400 block">{analytics.citation_clicks} citation clicks</span>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-[#131926] border border-[#232e42] shadow-md space-y-2">
          ...
          <span className="text-3xl font-extrabold text-amber-300 block">{(analytics.average_retrieval_score * 100).toFixed(1)}%</span>
          <span className="text-[10px] text-slate-400 block">Cosine vector match</span>
        </div>
      </div>
    </div>
  );
